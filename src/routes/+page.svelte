...
<div class="fixed inset-0 bg-black overflow-hidden">
	...
	<div class="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
		...
		<div class="space-y-6 text-center">
			<button
				onclick={() => goto('/cv')}
				class="menu-item block w-full text-white text-2xl md:text-3xl font-light tracking-wider px-8 py-4"
			>
			...
			<a
				href="https://linkedin.com/in/rivai-amin"
				target="_blank"
				rel="noopener noreferrer"
				class="menu-item block w-full text-white text-2xl md:text-3xl font-light tracking-wider px-8 py-4"
			>
			...
			<a
				href="https://instagram.com/rivai.amin"
				target="_blank"
				rel="noopener noreferrer"
				class="menu-item block w-full text-white text-2xl md:text-3xl font-light tracking-wider px-8 py-4"
			>
		...
		<div class="absolute bottom-6 md:bottom-8 left-0 right-0 flex justify-center gap-6 md:gap-8">
			...
			>
				<svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
					<path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.5 16.5l-6.5-3.75-6.5 3.75V7.5l6.5 3.75 6.5-3.75v9z"/>
				</svg>
			</a>
			<a
				href="https://instagram.com/rivai.amin"
