<script lang="ts">
	...
	onMount(() => {
		...
		const icons = {
			...
			person: `<svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm89.6 32h-11.2c-22.4 10.4-47.2 16-73.6 16s-51.2-5.6-73.6-16h-11.2C60.8 288 0 348.8 0 422.4V464c0 26.4 21.6 48 48 48h352c26.4 0 48-21.6 48-48v-41.6c0-73.6-60.8-134.4-134.4-134.4z"/></svg>`,
